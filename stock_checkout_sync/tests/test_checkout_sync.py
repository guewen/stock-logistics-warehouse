...
class TestCommonSyncDest(SavepointCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
...
class TestMoveCommonDestSyncLocation(TestCommonSyncDest):
    ...
    def setUpClass(cls):
        ...
        cls._update_qty_in_location(cls.stock_shelf_location, cls.product, 10)
        cls._update_qty_in_location(cls.stock_shelf_location, cls.product2, 10)
        ...
        cls.pick_move1 = cls._create_single_move(cls.pick_type, cls.product)
        cls.pack_move1 = cls._create_single_move(
            cls.pack_type, cls.product, move_orig=cls.pick_move1
        )
        cls.pick_move2 = cls._create_single_move(cls.pick_type, cls.product2)
        cls.pack_move2 = cls._create_single_move(
            cls.pack_type, cls.product2, move_orig=cls.pick_move2
        )
        cls.pick_move3 = cls._create_single_move(cls.pick_handover_type, cls.product)
        cls.pack_move3 = cls._create_single_move(
            cls.pack_type, cls.product, move_orig=cls.pick_move3
        )
        cls.pick_move4 = cls._create_single_move(cls.pick_type, cls.product2)
        cls.pack_move4 = cls._create_single_move(
            cls.pack_post_type, cls.product2, move_orig=cls.pick_move4
        )
        moves = (
            cls.pick_move1
            + cls.pack_move1
            ...
            [
                {
                    ...
                    "remaining_help": (
                        "<ul><li><strong>{}: 3 moves</strong></li>\n"
                        "<li>{}: 1 moves</li></ul>"
            ...
            [
                {
                    ...
                    "remaining_help": (
                        "<ul><li>{}: 3 moves</li>\n"
                        "<li><strong>{}: 1 moves</strong></li></ul>"
                    ).format(self.picking_pack.name, self.picking_pack_post.name),
